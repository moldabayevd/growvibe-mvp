    ...
    <section id="what" className="py-20 bg-white">
      <div className="max-w-4xl mx-auto px-6">
        ...
        <p className="text-ink-600 text-lg leading-relaxed mb-4">
          Мы не продаём курсы — мы приходим в команду и вместе делаем реальные
          продукты с помощью AI. Сотрудник описывает задачу обычными словами,
          а на выходе получает работающий сайт, приложение, форму или
          внутренний инструмент. Это первый этап движения Vibe 42 — адаптации
          человека к эпохе ИИ.
        </p>
        <p className="text-ink-600 text-lg leading-relaxed mb-10">
          Знание программирования не нужно. Главное — научить команду правильно
          ставить задачу, управлять результатом и доводить проект до рабочего
          вида вместе с AI.
        </p>
