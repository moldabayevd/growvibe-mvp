    ...
    <section id="what" className="py-20 bg-white">
      <div className="max-w-4xl mx-auto px-6">
        ...
        <p className="text-ink-600 text-lg leading-relaxed mb-4">
          Vibe 42 — нонпрофит движение. Мы не продаём курсы: мы приходим в команду
          и вместе делаем реальные продукты с помощью AI. Сотрудник описывает
          задачу обычными словами — и на выходе получает работающий сайт,
          приложение, форму или внутренний инструмент.
        </p>
