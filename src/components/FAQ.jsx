...
const faqs = [
  {
    ...
    a: 'Только офлайн — приходим в ваш офис или коворкинг. Это принципиально: вайб-кодинг быстрее осваивается, когда команда вместе в одном пространстве. Длительность и количество встреч согласуем после заявки — зависит от размера группы и задач.',
  },
  {
  ...
  },
  {
    ...
    a: 'От небольших отделов до больших групп. Оптимальный размер согласуем с вами под задачи и размер пространства вашего офиса.',
  },
  {
    q: 'Что нужно от компании?',
    a: 'Ноутбуки для участников и помещение (офис, конференц-зал или коворкинг). Всё остальное — программу, материалы, ведущего — берём на себя. Подписки на нужные AI-инструменты обсудим отдельно.',
  },
  {
    q: 'Как считается стоимость?',
    a: 'Стоимость зависит от количества сотрудников и программы. Рассчитаем индивидуально и пришлём предложение после заявки.',
  },
  {
