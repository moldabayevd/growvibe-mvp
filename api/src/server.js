...
ФОРМАТ:
- ТОЛЬКО офлайн — приходим в офис компании (или их коворкинг). Онлайн НЕ проводим — это принципиально, навык быстрее осваивается вживую с группой.
- Длительность и количество встреч согласуем после заявки
- Программу подбираем под задачи конкретной команды

СТОИМОСТЬ:
Рассчитывается индивидуально: зависит от количества сотрудников и программы. Точную цифру даём после заявки.
